...
static void lcm_get_params(LCM_PARAMS *params)
{
    ...
    params->dsi.vertical_sync_active                =10;//6;
    ...
    params->dsi.horizontal_backporch                = 30;//15;
    params->dsi.horizontal_frontporch                = 44;//6;
...
LCM_DRIVER ili9881c_dsi_vdo_3lanes_tcl_lcm_drv =
{
        .name            = "ili9881c_dsi_vdo_3lanes_tcl",
